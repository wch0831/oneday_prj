            ...
            <div class="form-w3agile form1">
               ...
               <form id="regForm" method="post" action="/registerServlet">
                  ...
                  <div class="key">
                     ...
                     <input  type="text"  value="Username" id="m_name" onfocus="this.value = '';" 
                           onblur="if (this.value == '') {this.value = 'Username';}" required="">
                     <div class="clearfix"></div>
                           <input  class="add pull-right" type="submit" value="중복확인" id="checkButton1">
                  </div>
                  	<div class="clearfix"></div>
                  ...
                  <input class="pull-right" type="submit" id="regButton" value="가입" >
               </form>
            </div>
